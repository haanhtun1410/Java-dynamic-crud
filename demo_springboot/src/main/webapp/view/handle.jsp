...
<body>
             ...
             <c:forEach var="object" items="${listDatas}">
                 <tr class="align-middle">
                     ...
                     <td class="text-truncate">
                         <a class="btn btn-danger" role="button" href="/api/curd/${entity}/delete/${valueId.toString()}"> Delete </a>
                         <a class="btn btn-primary product-update" role="button" href="/api/curd/${entity}/detail/${valueId.toString()}">
 ...
 <button type="button" class="btn btn-primary d-grid gap-2 col-6 m-auto create-modal" data-bs-toggle="modal" data-bs-target="#createModal">
     Add record
 </button>
     ...
     <div class="modal-dialog modal-lg">
         <div class="modal-content">
             ...
             <div class="modal-body">
                 <form method="POST" action="/api/curd/${entity}/add" name="formModel" >
